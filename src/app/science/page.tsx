...
export const metadata: Metadata = {
  title: "The Science",
  description:
    "Discover the science behind Game Plan Golf Performance. Clinically dosed nootropics, premium electrolytes, and powerful adaptogens — every ingredient backed by research.",
};
